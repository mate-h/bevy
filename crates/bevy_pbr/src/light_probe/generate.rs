...
impl Plugin for EnvironmentMapGenerationPlugin {
    ...
    fn finish(&self, app: &mut App) {
        ...
        embedded_asset!(app, "quadratic_b_spline_downsample.wesl");
        embedded_asset!(app, "temporal_blend_environment_map.wesl");
...
pub fn initialize_generated_environment_map_resources(
    ...
    let quadratic_shader =
        load_embedded_asset!(asset_server.as_ref(), "quadratic_b_spline_downsample.wesl");
    let temporal_shader =
        load_embedded_asset!(asset_server.as_ref(), "temporal_blend_environment_map.wesl");
